...
<c:if test="${empty admin }">
		...
		<div class="son_body" style="margin-top: -20px">
			...
			<div class="container-fluid">
				...
				<div class="col-md-3">
					...
					<div class="col-md-9">
								<form class="navbar-form  " action="${ctx }/AdminServlet?action=getAllWaitOrgList" method="post">
				...
				<div class="row" style="margin: 0;padding: 0;">
					<table class="table  table-bordered table-hover table-condensed">
						...
						<tr>
								<td colspan="10" style="font-weight: 600;">暂无待审核的组织信息</td>
							</tr>
						</c:if>
								<c:if test="${fn:length(OrgpageList)>0 }">
						...
						<tr>
								...
								<td>待审核</td>
								<td><a href="${ctx }/AdminServlet?action=passOrgregist&OId=${org.OId }&flag=wait" onclick="return confirm('通过该组织注册？');" class="btn btn-pass btn-xs">通过</a>
									<a href="${ctx }/AdminServlet?action=notpassOrgregist&OId=${org.OId }&flag=wait" onclick="return confirm('拒绝该组织注册？');" class="btn btn-danger btn-xs">拒绝</a>
								</td>
	...
	<script type="text/javascript">
		$(function() {
			...
			$(window).attr('location',"${ctx }/AdminServlet?action=getAllWaitOrgList&type=${type}&page="+page);
