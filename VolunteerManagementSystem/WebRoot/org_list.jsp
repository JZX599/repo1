				...
				<div class="row" style="margin-top: 5px;">
					<div class="panel  panel-success">
						<div class="panel-heading">
							<h3 class="panel-title" style="font-weight: bold;"><i class="glyphicon glyphicon-flag"></i>志愿服务组织查询</h3>
						</div>
						<div class="panel-body" style="padding-top: 0px;min-height: 500px;">
							...
							<div class="row" style="margin: 0;padding: 5px;">
								...
								<div class="col-md-6 col-sm-12 col-xs-12 ">
									<form class="navbar-form " action="${ctx }/IndexServlet?action=getAllPageOrgList" method="post">
										<select name="type" class="form-control input-sm col-md-3 ">
											...
											<option value="OEmail">组织邮箱</option>

										</select>
										<input type="text" name="txtSearch" class="form-control input-sm" placeholder="">
							...
							<div class="row" style="margin-top: 5px;">
								...
								<c:if test="${fn:length(OrgpageList)==0 }">
									<div class="col-md-12" style="margin-top: 15px;">
										<h4 class="text-center">暂无组织信息</h4>
									</div>
								</c:if>
								
								<c:if test="${fn:length(OrgpageList)>0 }">
				<c:forEach items="${OrgpageList }"  var="org">
										<div class="col-md-4 col-sm-6 col-xs-12" style="margin-top: 15px;">
										<a href="${ctx }/IndexServlet?action=getOrgInfo&OId=${org.OId}" class="list-group-item list-group-item-success">
											<div class="row" style="padding: 5px;">

												<span style="font-size: 18px; font-weight: 400;">${org.OName }</span>
											</div>
											<div class="row" style="padding: 5px;">
												<span style="font-size: 12px;"><i class="glyphicon glyphicon-user"></i>&nbsp;${org.OPerson }</span>&nbsp;&nbsp;&nbsp;&nbsp;
												<span style="font-size: 12px;"><i class="glyphicon glyphicon-envelope"></i>&nbsp;${org.OEmail }</span>

											</div>
											<div class="row" style="padding: 5px;">
												<i class="glyphicon glyphicon-map-marker"></i>
												<span style="font-size: 12px; ">${org.OAddress }</span>
												<span class="btn btn-info btn-sm pull-right" style="font-size: 12px;margin-left: 5px;line-height: 12px;">组织详情</span>
											</div>
										</a>
									</div>
...
<script type="text/javascript">
		$(function() {
			...
			$(window).attr('location',"${ctx }/IndexServlet?action=getAllPageOrgList&type=${type}&page="+page);
