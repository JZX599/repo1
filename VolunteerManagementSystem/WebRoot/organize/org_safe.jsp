...
<html>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${ctx }/OrganizeServlet?action=orgupdPassword" method="post" id="updpwd_form" >
		...
		<div class="modal fade bs-example-modal-sm" id="updemail_Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${ctx }/OrganizeServlet?action=orgupdEmail" method="post" id="updemail_form">
							<div class="form-group ">
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1">旧邮箱</span>
									<input type="text" class="form-control " name="oldemail" readonly="readonly" aria-describedby="basic-addon1" value="${organize.OEmail }">
								</div>
							</div>
        ...
        <input class="btn btn-success " type="button" id="btn_resend_email" onclick="checkemail();" value="发送验证码">
							...
							<div class="form-group " id="emailcodecheck_hint">
								<div class="input-group">
									...
									<input type="text"  class="form-control " id="emailcodecheck" name="org_updemail_code" placeholder="请输入新邮箱验证码" aria-describedby="basic-addon1">
								</div>
							</div>
							<div class="modal-footer">
	...
	<script src="${ctx }/js/ui/org_safe.js" type="text/javascript" charset="utf-8"></script>
