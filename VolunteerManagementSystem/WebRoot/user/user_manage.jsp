		...
		<header>
			...
			<div class="header_right">
				<div class="user_span_left">
					<span id="user_span"></span>&nbsp;<span id="user_name_span">${user.UName }</span>
				</div>
			...
			<div class="user_manage_article">
				...
				<div class="user_manage_list">
					...
					<div class="list_content">
						<ul>
							<li>
								<a href="${ctx }/UserServlet?action=getUPageBamList&usState=showAll&page=1" target="content"><span class="span1"></span>我的活动</a>
							</li>
							
							
							
							<li>
								<a href="${ctx }/user/user_info_upd.jsp" target="content"><span class="span3"></span>个人信息</a>
							</li>
							<li>
								<a href="${ctx }/UserServlet?action=getUserMsg" target="content"><span class="span4"></span>账号安全</a>
							</li>
							<li>
								<a href="${ctx }/UserServlet?action=Logout"  onclick="return confirm('您确认要退出吗？');" ><span class="span5"></span>退出</a>
							</li>
				...
				<div class="user_manage_view">
					<iframe id="" name="content" src="${ctx }/UserServlet?action=getUPageBamList&usState=showAll&page=1" frameborder="0" height="580px" width="100%" scrolling="no"> </iframe>
				</div>
			</div>
