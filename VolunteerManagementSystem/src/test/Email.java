...
public class Email {
	...
	// 发件人邮箱密码（有的是授权码）
	public static String emailPassword = "unktsujyabkibhee";
	// 发件人邮箱服务地址
	public static String emailSMTPHost = "smtp.qq.com";
	//  收件人邮箱
	public static String receiveMailAccount = "1072766478@qq.com";
	  /**
			 * @param session
			 * @param sendMail
			 * @param receiveMail
		...
		//  javaMail邮件发送
			public static void main(String[] args) {
				try {
					...
					System.out.println("mimeMessage.getSize----------"+message.getSize());
